...
<div class="sort_top">
    <div class="row">
        ...
        <div class="col-md-2 col-sm-3 col-xs-3 text-center"> 
            <div class="sort_icon fist"><a title="Grid view" class="<?php if($style=='2')echo'active'; ?>" href="<?php echo esc_url(add_query_arg(array('style'=>2))) ?>"><i class="fa fa-th-large "></i></a></div>
            <div class="sort_icon last"><a title="List view" class="<?php if($style=='1')echo'active'; ?>" href="<?php echo esc_url(add_query_arg(array('style'=>1))) ?>"><i class="fa fa-list "></i></a></div>
        </div>
    </div>
</div>

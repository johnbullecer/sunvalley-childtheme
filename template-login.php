    ...
    <div class="container">
        <div class="row row-wrap" data-gutter="60">
            ...
            <div class="col-md-4">
                ...
                <div class="mt5"><b><a class="btn-lg btn btn-primary" href="<?php echo get_permalink($page_user_register) ?>"><?php _e("Not yet a member? Register here!",ST_TEXTDOMAIN) ?></a></b></div>
